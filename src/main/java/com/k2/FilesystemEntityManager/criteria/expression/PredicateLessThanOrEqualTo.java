...
public class PredicateLessThanOrEqualTo extends AbstractPredicate implements FemPredicate {
	...
	public <Y extends Comparable<? super Y>> PredicateLessThanOrEqualTo(FemExpression<? extends Y> expr1, FemExpression<? extends Y> expr2) {
		this.expr1 = expr1;
		this.expr2 = expr2;
	}

	public <Y extends Comparable<? super Y>> PredicateLessThanOrEqualTo(FemExpression<? extends Y> expr, Y comp) {
		this.expr1 = expr;
		this.comp = comp;
	}
