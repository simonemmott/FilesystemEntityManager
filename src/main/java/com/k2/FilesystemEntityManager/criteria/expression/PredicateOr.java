...
public class PredicateOr extends AbstractPredicate implements FemPredicate {

	FemPredicate[] predicates = null;
	FemExpression<Boolean> boolExpr1 = null;
	FemExpression<Boolean> boolExpr2 = null;
	
	public PredicateOr(FemPredicate... predicates) {
		this.predicates = predicates;
	}

	public PredicateOr(FemExpression<Boolean> boolExpr1, FemExpression<Boolean> boolExpr2) {
