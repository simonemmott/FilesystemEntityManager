...
public class PredicateLE extends AbstractPredicate implements FemPredicate {
	
	private FemExpression<? extends Number> value1;
	private Object value2;

	public PredicateLE(FemExpression<? extends Number> expr1, FemExpression<? extends Number> expr2) {
		value1 = expr1;
		value2 = expr2;
	}

	public PredicateLE(FemExpression<? extends Number> expr, Number num) {
		value1 = expr;
		value2 = num;
	}
